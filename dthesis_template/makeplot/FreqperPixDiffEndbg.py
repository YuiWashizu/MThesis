...
def EnablePixel(filename, h1, h2, collistw, collistwo, tot1, tot2, tot3, tot4w, tot4wo, tot4wnom, tot4wonom, hit3, hit3than5):
    p1 = 0
    p2 = 0
    p3 = 0
    p4 = 0
    ...
    print("5. nhits3than5: {}".format(nhits3than5))
    print("##### hits ######################")
...
def main():
    ...
    hit3 = TH1F("hitperpix", "", 40, 0, 40)
    hit3than5 = TH1F("hit3than5", "", 40, 0, 40)
    ...
    EnablePixel(fileEn, freqw, freqwo, collistw, collistwo, tot1, tot2, tot3, tot4w, tot4wo, tot4wnom, tot4wonom, hit3, hit3than5)
