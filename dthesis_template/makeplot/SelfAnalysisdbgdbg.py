...
def main():
    ...
    h_nsig1 = TH1F("nhitsw", "", 100000, 0, 100000)
    ...
    h_wsig1 = TH2F("NwVSNsig1", "", 10000, 0, 10000, 10000, 0, 10000)
    ...
    FitPoisson(h_nsigfit, 0, 120, 15)
    FitPoisson(h_nsigfitzoom, 0, 120, 15)
